...
abstract class BaseCommand {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return this.name == other.name && this.aliases.toList() == other.aliases.toList() && this.description == other.description && this.usage == other.usage && this.commandType == other.commandType
    }
