...
internal open class DummyGame(cardstock: Cardstock, channel: Channel) : Game<DummyPlayer>(cardstock, channel) {
    override fun getPlayer(user: User, create: Boolean): DummyPlayer? {
        ...
        return DummyPlayer(user).apply { this@DummyGame._players.add(this) }
    }
